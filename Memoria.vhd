...
ARCHITECTURE behavioral_arch OF Memoria IS
    ...
    signal addS0		: STD_LOGIC_VECTOR (ADDR_WIDTH-1 DOWNTO 0) := (others => '0');
	signal addS1		: STD_LOGIC_VECTOR (ADDR_WIDTH-1 DOWNTO 0) := (others => '0');
	signal addS2		: STD_LOGIC_VECTOR (ADDR_WIDTH-1 DOWNTO 0) := (others => '0');
	signal addS3		: STD_LOGIC_VECTOR (ADDR_WIDTH-1 DOWNTO 0) := (others => '0');
    ...
    signal add0			: integer := 0;
	signal add2			: integer := 0;
	signal add1			: integer := 0;
	signal add3			: integer := 0;
    signal addu			: unsigned(7 downto 0) := (others => '0');
...
---- Usa apenas 8 bits menos significativos do endereço
     add <= To_BitVector(clean_slv(Address(7 downto 0)));
--
...
-- Bancos de memórias (cada banco possui 256 bytes)
	MEM: lpm_ram_dq
	GENERIC MAP (lpm_widthad => ADDR_WIDTH, lpm_width => DATA_WIDTH, lpm_file => INIT_FILE, intended_device_family => "Cyclone IV E")
